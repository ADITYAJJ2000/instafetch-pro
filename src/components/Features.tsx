...
export function Features() {
  return <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-16 max-w-4xl mx-auto">
      {features.map((feature, index) => <div key={index} className="group relative bg-card/40 backdrop-blur-glass border border-border/30 p-4 text-center hover:border-primary/30 transition-all duration-300 rounded-lg">
